...
class BST {
    ...
    public void printTreeLevelOrder() {
        ...
        if (root == null) return;
        Queue<BSTNode> q = new LinkedList<>(); // declare a data structure to hold each line
        ...
        while (true) {
            ...
            System.out.println();// prints each level on a separate line
